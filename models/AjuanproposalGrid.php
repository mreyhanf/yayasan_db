 ...
 * Page class
 */
class AjuanproposalGrid extends Ajuanproposal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AjuanproposalGrid";
    ...
    public $FormName = "fajuanproposalgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idTargetProposal->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'ajuanproposal'
        ...
        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['idTargetProposal']) == "") {
            $this->setFailureMessage($Language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }
