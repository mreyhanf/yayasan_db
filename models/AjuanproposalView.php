 ...
 * Page class
 */
class AjuanproposalView extends Ajuanproposal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AjuanproposalView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("idProyek") ?? Route("idProyek")) !== null) {
                ...
                $returnUrl = "AjuanproposalList"; // Return to list
            }
            if (($keyValue = Get("idTargetProposal") ?? Route("idTargetProposal")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "AjuanproposalList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "AjuanproposalList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
