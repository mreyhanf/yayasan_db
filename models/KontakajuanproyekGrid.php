 ...
 * Page class
 */
class KontakajuanproyekGrid extends Kontakajuanproyek
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KontakajuanproyekGrid";
    ...
    public $FormName = "fkontakajuanproyekgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_idAjuanProyek") && $CurrentForm->hasValue("o_idAjuanProyek") && $this->idAjuanProyek->CurrentValue != $this->idAjuanProyek->OldValue) {
            return false;
        }
        return true;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_idAjuanProyek")) {
            $this->idAjuanProyek->setOldValue($CurrentForm->getValue("o_idAjuanProyek"));
        }
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'kontakajuanproyek'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["idAjuanProyek"] = $this->idAjuanProyek->CurrentValue;
        $masterTable = Container("ajuanproyek");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
        ...
        // idAjuanProyek
        $this->idAjuanProyek->setDbValueDef($rsnew, $this->idAjuanProyek->CurrentValue, 0, false);
