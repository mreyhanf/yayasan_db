 ...
 * Page class
 */
class TargetproposalEdit extends Targetproposal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TargetproposalEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("idTargetProposal") ?? Key(0) ?? Route(2)) !== null) {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("kontaktargetproposal", $detailTblVar) && $detailPage->DetailEdit) {
