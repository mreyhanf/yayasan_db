...
class Userlevels extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->userlevelid->Lookup = new Lookup('userlevelid', 'userlevels', false, 'userlevelid', ["userlevelname","","",""], [], [], [], [], [], [], '', '', "`userlevelname`");
    ...
    public function renderListRow()
    {
        ...
        $arwrk = [];
        $arwrk["lf"] = $this->userlevelname->CurrentValue;
        $arwrk["df"] = $this->userlevelname->CurrentValue;
        $arwrk = $this->userlevelid->Lookup->renderViewRow($arwrk, $this);
        $dispVal = $this->userlevelid->displayValue($arwrk);
        if ($dispVal != "") {
            $this->userlevelid->ViewValue = $dispVal;
        }
