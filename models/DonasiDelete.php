 ...
 * Page class
 */
class DonasiDelete extends Donasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DonasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DonasiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DonasiList"); // Return to list
                return;
            }
        }
