 ...
 * Page class
 */
class ProyekDelete extends Proyek
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProyekDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProyekList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ProyekList"); // Return to list
                return;
            }
        }
