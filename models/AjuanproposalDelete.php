 ...
 * Page class
 */
class AjuanproposalDelete extends Ajuanproposal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AjuanproposalDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AjuanproposalList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AjuanproposalList"); // Return to list
                return;
            }
        }
