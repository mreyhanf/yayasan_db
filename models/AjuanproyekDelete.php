 ...
 * Page class
 */
class AjuanproyekDelete extends Ajuanproyek
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AjuanproyekDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AjuanproyekList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AjuanproyekList"); // Return to list
                return;
            }
        }
