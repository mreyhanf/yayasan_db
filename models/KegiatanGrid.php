 ...
 * Page class
 */
class KegiatanGrid extends Kegiatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KegiatanGrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_penanggungJawab") && $CurrentForm->hasValue("o_penanggungJawab") && $this->penanggungJawab->CurrentValue != $this->penanggungJawab->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->penanggungJawab->clearErrorMessage();
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetall") {
                ...
                $this->DbMasterFilter = "";
                $this->DbDetailFilter = "";
                        $this->penanggungJawab->setSessionValue("");
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idKegiatan->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
        ...
        if ($CurrentForm->hasValue("o_penanggungJawab")) {
            $this->penanggungJawab->setOldValue($CurrentForm->getValue("o_penanggungJawab"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->penanggungJawab->getSessionValue() != "") {
                $this->penanggungJawab->CurrentValue = GetForeignKeyValue($this->penanggungJawab->getSessionValue());
                $this->penanggungJawab->OldValue = $this->penanggungJawab->CurrentValue;
                $curVal = strval($this->penanggungJawab->CurrentValue);
                if ($curVal != "") {
                    $this->penanggungJawab->ViewValue = $this->penanggungJawab->lookupCacheOption($curVal);
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            $detailKeys = [];
            $keyValue = $rsnew['penanggungJawab'] ?? $rsold['penanggungJawab'];
            $detailKeys['penanggungJawab'] = $keyValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "anggota") {
            $this->penanggungJawab->CurrentValue = $this->penanggungJawab->getSessionValue();
        }

        // Check referential integrity for master table 'kegiatan'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["penanggungJawab"] = $this->penanggungJawab->CurrentValue;
        $masterTable = Container("anggota");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "anggota") {
            $masterTbl = Container("anggota");
            $this->penanggungJawab->Visible = false;
