 ...
 * Page class
 */
class KontaktargetproposalEdit extends Kontaktargetproposal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KontaktargetproposalEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("KontaktargetproposalList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "KontaktargetproposalList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // idTargetProposal
            if ($this->idTargetProposal->getSessionValue() != "") {
                $this->idTargetProposal->ReadOnly = true;
            }
            $this->idTargetProposal->setDbValueDef($rsnew, $this->idTargetProposal->CurrentValue, 0, $this->idTargetProposal->ReadOnly);

            // Check referential integrity for master table 'targetproposal'
            $detailKeys = [];
            $keyValue = $rsnew['idTargetProposal'] ?? $rsold['idTargetProposal'];
            $detailKeys['idTargetProposal'] = $keyValue;
            $masterTable = Container("targetproposal");
            ...
            if (!$validMasterRecord) {
                $relatedRecordMsg = str_replace("%t", "targetproposal", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("KontaktargetproposalList"), "", $this->TableVar, true);
        $pageId = "edit";
