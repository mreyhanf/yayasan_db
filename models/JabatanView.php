 ...
 * Page class
 */
class JabatanView extends Jabatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JabatanView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idJabatan") ?? Route("idJabatan")) !== null) {
            $this->RecKey["idJabatan"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("idJabatan") ?? Route("idJabatan")) !== null) {
                ...
                $this->RecKey["idJabatan"] = $this->idJabatan->QueryStringValue;
            } elseif (Post("idJabatan") !== null) {
                $this->idJabatan->setFormValue(Post("idJabatan"));
                $this->RecKey["idJabatan"] = $this->idJabatan->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->idJabatan->setQueryStringValue($keyValue);
                $this->RecKey["idJabatan"] = $this->idJabatan->QueryStringValue;
            } else {
                $returnUrl = "JabatanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "JabatanList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "JabatanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
