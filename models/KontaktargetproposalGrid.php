 ...
 * Page class
 */
class KontaktargetproposalGrid extends Kontaktargetproposal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KontaktargetproposalGrid";
    ...
    public $FormName = "fkontaktargetproposalgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_idTargetProposal") && $CurrentForm->hasValue("o_idTargetProposal") && $this->idTargetProposal->CurrentValue != $this->idTargetProposal->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->idTargetProposal->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->idTargetProposal->OldValue = $this->idTargetProposal->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['idTargetProposal'] = $this->idTargetProposal->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "targetproposal") {
            $this->idTargetProposal->CurrentValue = $this->idTargetProposal->getSessionValue();
        }

        // Check referential integrity for master table 'kontaktargetproposal'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["idTargetProposal"] = $this->idTargetProposal->CurrentValue;
        $masterTable = Container("targetproposal");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
        ...
        // idTargetProposal
        $this->idTargetProposal->setDbValueDef($rsnew, $this->idTargetProposal->CurrentValue, 0, false);
