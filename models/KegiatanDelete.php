 ...
 * Page class
 */
class KegiatanDelete extends Kegiatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KegiatanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KegiatanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KegiatanList"); // Return to list
                return;
            }
        }
