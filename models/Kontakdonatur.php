...
/**
 * Table class for kontakdonatur
 */
class Kontakdonatur extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'kontakdonatur';
        $this->TableName = 'kontakdonatur';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`kontakdonatur`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->idDonatur->Nullable = false; // NOT NULL field
        $this->idDonatur->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`kontakdonatur`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("KontakdonaturList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "KontakdonaturEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "KontakdonaturAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "KontakdonaturView";
            case Config("API_ADD_ACTION"):
                return "KontakdonaturAdd";
            case Config("API_EDIT_ACTION"):
                return "KontakdonaturEdit";
            case Config("API_DELETE_ACTION"):
                return "KontakdonaturDelete";
            case Config("API_LIST_ACTION"):
                return "KontakdonaturList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("KontakdonaturView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("KontakdonaturView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "KontakdonaturAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "KontakdonaturAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("KontakdonaturEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("KontakdonaturAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("KontakdonaturDelete", $this->getUrlParm());
    }
