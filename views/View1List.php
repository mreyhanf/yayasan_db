...
<?php if ($Page->nama->Visible) { // nama ?>
        <th data-name="nama" class="<?= $Page->nama->headerCellClass() ?>"><div id="elh_view1_nama" class="view1_nama"><?= $Page->renderFieldHeader($Page->nama) ?></div></th>
<?php } ?>
<?php if ($Page->alamat->Visible) { // alamat ?>
        <th data-name="alamat" class="<?= $Page->alamat->headerCellClass() ?>"><div id="elh_view1_alamat" class="view1_alamat"><?= $Page->renderFieldHeader($Page->alamat) ?></div></th>
<?php } ?>
<?php if ($Page->kesibukan->Visible) { // kesibukan ?>
        <th data-name="kesibukan" class="<?= $Page->kesibukan->headerCellClass() ?>"><div id="elh_view1_kesibukan" class="view1_kesibukan"><?= $Page->renderFieldHeader($Page->kesibukan) ?></div></th>
<?php } ?>
<?php if ($Page->Jabatan->Visible) { // Jabatan ?>
        <th data-name="Jabatan" class="<?= $Page->Jabatan->headerCellClass() ?>"><div id="elh_view1_Jabatan" class="view1_Jabatan"><?= $Page->renderFieldHeader($Page->Jabatan) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_view1_nama" class="el_view1_nama">
...
<span id="el<?= $Page->RowCount ?>_view1_alamat" class="el_view1_alamat">
...
<span id="el<?= $Page->RowCount ?>_view1_kesibukan" class="el_view1_kesibukan">
...
<span id="el<?= $Page->RowCount ?>_view1_Jabatan" class="el_view1_Jabatan">
