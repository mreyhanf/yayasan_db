...
<?php if ($Page->idJabatan->Visible) { // idJabatan ?>
        <th class="<?= $Page->idJabatan->headerCellClass() ?>"><span id="elh_jabatan_idJabatan" class="jabatan_idJabatan"><?= $Page->idJabatan->caption() ?></span></th>
<?php } ?>
<?php if ($Page->nama->Visible) { // nama ?>
        <th class="<?= $Page->nama->headerCellClass() ?>"><span id="elh_jabatan_nama" class="jabatan_nama"><?= $Page->nama->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
