...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fajuanproyekadd = new ew.Form("fajuanproyekadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fajuanproyekadd;

    // Add fields
    var fields = currentTable.fields;
    fajuanproyekadd.addFields([
    ...
    // Form_CustomValidate
    fajuanproyekadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fajuanproyekadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fajuanproyekadd.lists.keputusan = <?= $Page->keputusan->toClientList($Page) ?>;
    loadjs.done("fajuanproyekadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fajuanproyekadd" id="fajuanproyekadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fajuanproyekadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fajuanproyekadd", "x_tanggalPengajuan", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <?php if (strval($Page->idAjuanProyek->getSessionValue()) != "") { ?>
    <input type="hidden" name="x_idAjuanProyek" id="x_idAjuanProyek" value="<?= HtmlEncode(strval($Page->idAjuanProyek->getSessionValue())) ?>">
    <?php } ?>
<?php
    if (in_array("kontakajuanproyek", explode(",", $Page->getCurrentDetailTable())) && $kontakajuanproyek->DetailAdd) {
?>
