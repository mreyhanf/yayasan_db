...
// Page object
$KontakajuanproyekAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { kontakajuanproyek: currentTable } });
var currentForm, currentPageID;
var fkontakajuanproyekadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fkontakajuanproyekadd = new ew.Form("fkontakajuanproyekadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fkontakajuanproyekadd;

    // Add fields
    var fields = currentTable.fields;
    fkontakajuanproyekadd.addFields([
    ...
    // Form_CustomValidate
    fkontakajuanproyekadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkontakajuanproyekadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fkontakajuanproyekadd.lists.idAjuanProyek = <?= $Page->idAjuanProyek->toClientList($Page) ?>;
    loadjs.done("fkontakajuanproyekadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fkontakajuanproyekadd" id="fkontakajuanproyekadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_kontakajuanproyek_idAjuanProyek">
    <select
        ...
        data-select2-id="fkontakajuanproyekadd_x_idAjuanProyek"
...
<script>
loadjs.ready("fkontakajuanproyekadd", function() {
    var options = { name: "x_idAjuanProyek", selectId: "fkontakajuanproyekadd_x_idAjuanProyek" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fkontakajuanproyekadd.lists.idAjuanProyek.lookupOptions.length) {
        options.data = { id: "x_idAjuanProyek", form: "fkontakajuanproyekadd" };
    } else {
        options.ajax = { id: "x_idAjuanProyek", form: "fkontakajuanproyekadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
