...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'A4kmK2LRp4zy2Mt0', // Random key for encryption
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-olive",
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-olive navbar-dark border-bottom-0",
